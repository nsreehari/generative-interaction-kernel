...
import profileArtifact from "../../profiles/portfolio-tracker-no-cells/profile.json" with { type: "json" };
import presentationRecipe from "../../profiles/portfolio-tracker-no-cells/portfolio-to-presentation.recipe.json" with { type: "json" };
import runtimeRecipe from "../../profiles/portfolio-tracker-no-cells/presentation-to-runtime.recipe.json" with { type: "json" };
